    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="editClientForm" method="post" action="{{ route('admin.update', $client->id) }}">                                                      @csrf
              @method('put')
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary update" id="submitEditClientForm">Save changes</button>
              </div>
          </form>
        </div>
