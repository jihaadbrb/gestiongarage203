            ...
            <div class="modal-body">
                <form id="importUsersForm" method="post" action="{{ route('import.users') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">
                            Supported file formats: .xlsx, .xls (older Excel versions)
                        </div>
                    </div>
                    <div class="alert alert-info" role="alert">
                        <p>Your Excel file should have columns for name, email (must be unique), password (hashed), role (optional: defaults to 'client'), address (required), and phone number (required).</p>
                    </div>
